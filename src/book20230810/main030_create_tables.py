...
CREATE TABLE data (id INT PRIMARY KEY, title VARCHAR(255), author_name VARCHAR(255), author_name2 VARCHAR(255), date VARCHAR(255), work_category VARCHAR(255), comment VARCHAR(255));
'''
